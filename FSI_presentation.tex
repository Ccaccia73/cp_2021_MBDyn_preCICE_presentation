...
\begin{itemize}
    %\item currently update in \textbf{adapter}
...
\footnotesize
\begin{table}[h!]
%\caption{FSI3 results (displacements)}
\label{tab:fsi3_d}
\begin{center}
...
\hline
%25k & 4   & -2.53$\pm$2.22 & 9.19 & 2$\pm$40.28 & 4.59   \\
25k & 4 & -3.51$\pm$2.77 & 9.24 & 1.38$\pm$45.9 & 4.59   \\
\hline
%49k  & 4   & -1.42$\pm$1.45   & 9.57 & 1.82$\pm$29.33 & 4.79 \\
...
\hline
%25k & 4   & 501.12$\pm$30.11 & 9.19 & 3.37$\pm$97.31 & 4.59   \\
25k & 4   & 502.62$\pm$30.03 & 9.24 & 1.51$\pm$97.31 & 4.59   \\
\hline
%49k & 4    & 476.83$\pm$21.55   & 9.57 & 1.27$\pm$98.53 & 4.79 \\
